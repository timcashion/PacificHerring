...
licences$OWNER[which(licences$Licence_Holder %in% pattison)] <- "Pattison"
...
lic_area$Group <- gsub(lic_area$Group, pattern="QCI", replacement="HG")
lic_area$Group <- gsub(lic_area$Group, pattern="GULF", replacement="SoG")

lic_area$Group[is.na(lic_area$Group)] <- "UNKNOWN AREA"
#lic_area$Group <- str_to_title(lic_area$Group)
