...
ggplotly(herring_lic_area_plot, width = 900, height =600) %>% 
...
top_10_company_table <- group_by(lic_2018, Licence_Holder) %>%
  ...
  tally(n) 
colnames(top_10_company_table)[2] <- "Count"

pattison_roe_combined_number <- top_10_company_table$Count[which(top_10_company_table$Licence_Holder=="JIM PATTISON GROUP")]
top10_roe_combined_number <- sum(top_10_company_table$Count[which(top_10_company_table$Licence_Holder!="Other")])

total_roe_combined_licences <- sum(top_10_company_table$Count)
top10_roe_combined_percent <- top10_roe_combined_number /total_roe_combined_licences * 100
pattison_roe_combined <- top_10_company_table$Count[which(top_10_company_table$Licence_Holder=="JIM PATTISON GROUP")]/ sum(top_10_company_table$Count) #Pattison companies own 15.5% of licences. 
