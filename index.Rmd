...
theme_set(theme_ipsum_rc() + 
            theme(text=element_text(family="Alegreya Sans SC Light"),
                  axis.title.x = element_text(family="Alegreya Sans SC Light"),
                  axis.title.y = element_text(family="Alegreya Sans SC Light")
                  ))
...
```{r catch-by-type, echo=F, warning=F, message=F, fig.cap="Catch of herring by fishery type. Source: BC Ministry of Agriculture, 2018."}
...
```{r bar-chart-area-use, echo=F, warning=F, message=F, fig.cap="Expected catches (metric tonnes) of herring by area and fishery for the 2019 season. Source: DFO, 2018"}
...
```{r roe-fishery-sog, echo=F, warning=F, message=F, fig.cap="Roe herring landings by gear and  area. Source: Compiled season summary data from DFO reports."}
...
```{r landed-value, echo=F, warning=F, message=F, fig.cap="Ex-vessel value of herring fisheries. Source: BC Ministry of Agriculture, 2018."}
...
```{r wholesale-value, echo=F, warning=F, message=F, fig.cap="Wholesale value of herring fisheries. Source: BC Ministry of Agriculture, 2018."}
...
```{r ex-vessel-price, echo=F, warning=F, message=F, fig.cap="Ex-vessel price by fishery. Source: BC Ministry of Agriculture, 2018."}
fisherytype_value <- read_csv("./Data/HerringValueFisheries.csv")
fisherytype_value <- fisherytype_value %>%
  mutate_if(is.character, as.factor) %>%
  filter(Fishery != "Total")
...
```{r value-added-plot, echo=F, warning=F, message=F, fig.cap="Value-added factor by fishery. Source: BC Ministry of Agriculture, 2018."}
...
```{r bc-seafood,  echo=F, warning=F, message=F, fig.cap="Harvest and value (landed and wholesale) of BC seafood production averaged over 2014-2016. Source: BC AgriService 2017."}
bc_seafood <- read_csv("./Data/BC_Seafood_Production.csv")
bc_seafood$System <- "wild"
bc_seafood$System[grepl(bc_seafood$Group , pattern="Farmed", ignore.case=T)] <- "farmed"
...
```{r recreational-fishes, echo=F, warning=F, message=F, fig.cap="Recreational salmon landings (tidal water) in BC by area for 2009. JDFS: Juan de Fuca Strait; JS: Johnstone Strait; NC: North Central Coast; SoG: Strait of Georgia; WCVI: West Coast of Vancouver Island. Source: DFO, 2016"}
...
```{r recreational-value, echo=F, warning=F, message=F, fig.cap="Recreational salmon value (tidal water) in BC by area  for 2009. JDFS: Juan de Fuca Strait; JS: Johnstone Strait; NC: North Central Coast; SoG: Strait of Georgia; WCVI: West Coast of Vancouver Island. Source: Estimated based on commercial value of salmon and landings data from DFO, 2016"}
